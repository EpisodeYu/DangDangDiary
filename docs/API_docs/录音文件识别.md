...
-   **Fun-ASR**：fun-asr（稳定版，当前等同fun-asr-2025-11-07）、fun-asr-2025-11-07（快照版）、fun-asr-2025-08-25（快照版）、fun-asr-mtl（稳定版，当前等同fun-asr-mtl-2025-08-25，建议使用fun-asr）、fun-asr-mtl-2025-08-25（快照版）
...
| **场景** | **推荐模型** | **理由** |
| --- | --- | --- |
| 中文及多语言识别（会议/直播/跨国交流/教育） | fun-asr | 覆盖汉语七大方言及 20+ 地区口音，支持 30 个语种，输出文本自动规范化，一个模型满足多语言识别需求，简化开发与部署成本 |
